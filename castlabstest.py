...
#Approach without setting up logs
# s = Service("C:/Users/grayb/Desktop/castlabs/chromedriver.exe")
...
try:
    ...
    """
    for logline in driver.get_log('browser'):
        if "seeking" in str(logline):
            print("Seeking confirmed")
    ...
    for logline in driver.get_log('browser'):
        if "ratechange" in str(logline):
            print("Ratechange confirmed")
